...
const SignIn = () => {
  ...
  // Add new state for role selection
  ...
  const handleLinkedInLogin = () => {
    window.location.href = `${
      import.meta.env.VITE_API_URL
    }/auth/linkedin?role=${role}`;
  };
  const handleGithubLogin = () => {
    window.location.href = `${
      import.meta.env.VITE_API_URL
    }/auth/github?role=${role}`;
  };

  return (
    <div className="min-h-screen w-screen  mt-16 flex items-center justify-center bg-gray-100 px-4 sm:px-6 lg:px-8">
